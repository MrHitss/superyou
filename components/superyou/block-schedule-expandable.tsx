...
interface BlockScheduleExpandableProps {
  block: ContentBlock;
  onSave: (blockId: string, schedule: ContentBlockSchedule) => void;
  onClose: () => void;
}

export function BlockScheduleExpandable({
  block,
  onSave,
  onClose,
}: BlockScheduleExpandableProps) {
    ...
    <div className="border-t border-border bg-muted/20">
      ...
      <div className="space-y-4 px-4 py-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">Leave empty to show until you remove it.</p>
        </div>
        <div className="space-y-2">
